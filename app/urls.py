...
urlpatterns = [
    ...
    path('OS/detail_ing/', views.detail_ing2_1, name='detail_ing2_1'),
    path('CI/detail_ing/', views.detail_ing2_2, name='detail_ing2_2'),
    path('SR/detail_ing/', views.detail_ing2_3, name='detail_ing2_3'),
